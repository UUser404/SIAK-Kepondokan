...
<head>
    ...
    <style>
        ...
        /* Perbaikan: input/select/textarea di banyak form pakai bg-gray-50 tanpa
        dark:bg-..., jadi kalau dark mode aktif teksnya (text-siakad-dark -> putih)
        jadi tidak kebaca di atas bg-gray-50 yang tetap hampir putih. */
        .dark input,
        .dark select,
        .dark textarea {
