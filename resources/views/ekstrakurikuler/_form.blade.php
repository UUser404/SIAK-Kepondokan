{{-- ============================================================ --}}
{{-- resources/views/ekstrakurikuler/_form.blade.php              --}}
{{-- ============================================================ --}}
<div class="card-saas dark:bg-gray-800 overflow-hidden">
    <div class="px-5 py-3.5 flex items-center gap-2"
        ...
        <h3 class="font-semibold text-sm text-siakad-dark dark:text-white">Detail Ekstrakurikuler</h3>
    </div>
    <div class="p-5 space-y-4">
        ...
        <div>
            ...
            <input type="text" name="nama"
                ...
                placeholder="e.g. Pramuka" required
        ...
        <div>
            ...
            <input type="text" name="pembina"
                ...
                class="w-full px-3.5 py-2.5 text-sm rounded-xl border
                          ...
                          text-siakad-dark dark:text-white placeholder-gray-400
                          focus:ring-2 outline-none transition">
            @error('pembina')<p class="text-xs text-red-600 mt-1">{{ $message }}</p>@enderror
        </div>
