{{-- ============================================================ --}}
{{-- resources/views/tingkatan/edit.blade.php                     --}}
{{-- ============================================================ --}}
<x-app-layout>
    <x-slot name="header">Edit Tingkatan</x-slot>
    ...
    <form method="POST" action="{{ route('admin.tingkatan.update', $tingkatan) }}" class="max-w-xl">
        @csrf @method('PUT')
        @include('tingkatan._form', ['submitLabel' => 'Perbarui'])
    </form>
</x-app-layout>